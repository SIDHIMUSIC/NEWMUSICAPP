 ...
 *
 * SIDHI Music is GPL-3.0-or-later because it links the NewPipe Extractor, and that
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.card}>
          <Text style={styles.legalTitle}>SIDHI Music</Text>
          <Text style={styles.legalBody}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.legalBody}>
            ...
            {'\n\n'}
            SIDHI Music uses it, unmodified, to resolve playable audio. No NewPipe source
            is included in this app, and linking it is why SIDHI Music carries the same
            licence.
          </Text>
