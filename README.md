...
SIDHI Music is a free, open-source music player. You search for a song, tap it, and it plays —
...
device only**. There is no SIDHI Music account, no SIDHI Music server, and nothing is sent anywhere
...
Please read this section before using, building, or redistributing SIDHI Music.

## License

**SIDHI Music is licensed under the GNU General Public License, version 3 or (at your option) any
...
```
SIDHI Music — a music player for Android
...
SIDHI Music links the **NewPipe Extractor**, which is GPL-3.0-or-later. GPL is a copyleft
license, so any distributed work that combines with it must be released under the same
terms. SIDHI Music is therefore GPL-3.0-or-later. This is not optional and not a preference — it
...
You may **use, study, modify, and redistribute** SIDHI Music, including commercially. In exchange,
if you distribute SIDHI Music or any derivative of it — modified or not, as source or as an APK —
you must:
...
You may **not** relicense SIDHI Music or any derivative under a permissive or proprietary license,
...
by GPL-3.0-or-later §3 and §6. If you received a SIDHI Music binary from anywhere else and cannot
...
You use SIDHI Music entirely at your own risk. The author accepts no liability for any damages
...
- SIDHI Music is **not affiliated with, authorised by, endorsed by, or sponsored by Google LLC,
...
- SIDHI Music is **not affiliated with Team NewPipe.** NewPipe Extractor is used as an
  independent, unmodified library under its own license, and its authors have no
  involvement in this project.
- SIDHI Music is an independent project by Sanyam Jain.

## No content is hosted or distributed

**SIDHI Music does not host, store, upload, cache for redistribution, or provide any music, audio,
video, or other copyrighted content.** It contains no media library of its own.

SIDHI Music is a client. It performs the same kind of requests a browser performs, on your device,
...
By using SIDHI Music you accept that:
...
- SIDHI Music is published as **free software for personal, educational, and interoperability
...
SIDHI Music has no account system, no analytics, no telemetry, no crash reporting, and no server
...
network requests SIDHI Music makes are those required to fulfil a search or play a track you
selected.
